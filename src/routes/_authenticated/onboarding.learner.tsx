        ...
        <section className="mt-6 space-y-5 rounded-2xl border border-border bg-card p-6 shadow-card">
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <Field label={role === "parent" ? "Child's class / grade" : "Class / grade"}>
              <Select
                value={sp.class_grade || undefined}
                onValueChange={(v) => setSp({ ...sp, class_grade: v })}
              >
                <SelectTrigger>
            ...
            <Field label="Preferred mode of learning">
              <Select
                value={sp.mode_preference}
                onValueChange={(v) => setSp({ ...sp, mode_preference: v as any })}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
                    ...
                    >
                      ...
                      <button
                        onClick={() =>
                          setSp({
                            ...sp,
                            subjects_of_interest: sp.subjects_of_interest.filter((x) => x !== s),
                          })
                        }
                      >
                        <X className="h-3 w-3" />
              ...
              <Button
                ...
                onClick={() => {
                  if (draft.trim()) {
                    setSp({
                      ...sp,
                      subjects_of_interest: [...sp.subjects_of_interest, draft.trim()],
                    });
                    setDraft("");
                  }
                }}
