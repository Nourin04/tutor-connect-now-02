  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-5xl px-4 py-10 sm:px-6 lg:px-8">
        <Link to="/tutors" className="text-sm text-muted-foreground hover:text-primary">
          ← Back to all tutors
        </Link>
            ...
            <section className="rounded-2xl border border-border bg-card p-6 shadow-card">
              <div className="flex flex-col gap-4 sm:flex-row sm:items-start">
                ...
                <div className="flex-1">
                  ...
                  {tutor.bio && (
                    <p className="mt-4 text-sm leading-relaxed text-foreground/90">{tutor.bio}</p>
                  )}
                </div>
              </div>
            </section>
            ...
            <div className="rounded-2xl border border-border bg-card p-5 shadow-card">
              ...
              <div className="mt-5">
                ...
                <p className="mt-3 text-xs text-muted-foreground">
                  TutorConnect doesn't charge any fee. Lessons are arranged directly between you and
                  the tutor.
                </p>
              </div>
            </div>
