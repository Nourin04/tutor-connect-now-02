      ...
      <main className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <article className="prose-content mt-8 space-y-6 text-sm leading-relaxed text-foreground/90">
          <Section title="1. What TutorConnect is">
            <p>TutorConnect is a discovery platform that helps parents and students find independent tutors in their area. We don't employ tutors, vet them, or take part in lessons or payments. We just help you find each other.</p>
          </Section>
          <Section title="2. Accounts">
            <p>You must be at least 13 to create an account, and 18+ if you're registering as a tutor. Parents can register and manage accounts on behalf of a child. You're responsible for keeping your password safe.</p>
          </Section>
          ...
          <Section title="6. Fees">
            <p>TutorConnect is currently free to use for both learners and tutors. We don't take commissions on tuition fees in this phase.</p>
          </Section>
