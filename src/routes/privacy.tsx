        ...
        <article className="mt-8 space-y-6 text-sm leading-relaxed text-foreground/90">
          <Section title="What we collect">
            <ul className="list-disc space-y-1 pl-5">
              ...
              <li>Profile info you choose to share: location, qualifications, subjects, fees, availability, photo, bio.</li>
              <li>Activity info: tutors you view, contact-reveal events, reviews you leave.</li>
              <li>Basic technical data: IP address, device, and browser info for security and reliability.</li>
            </ul>
          </Section>
          ...
          <Section title="What we share">
            <p>Your public tutor profile (if you're a tutor) is visible to anyone visiting TutorConnect. Contact details are shown to a learner only after they click "Reveal contact". We don't sell personal data.</p>
          </Section>
          <Section title="Cookies & analytics">
            <p>We use a small number of cookies to keep you signed in and understand product usage in aggregate.</p>
          </Section>
          <Section title="Data retention">
            <p>We keep your account data while your account is active. If you delete your account, we remove your profile from public view and delete personal data within 30 days, except where we're required to retain it for legal reasons.</p>
          </Section>
